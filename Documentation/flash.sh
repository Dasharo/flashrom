...
# Set these according to the chip you want to use
CHIP_THINKPAD_SPI1="MX25L6406E/MX25L6408E"
CHIP_THINKPAD_SPI2="MX25L3206E/MX25L3208E"
FLASHROM_CHIP="-c $CHIP_THINKPAD_SPI2"
WP_RANGE="0,0x00400000"
...
case "$CMD" in
  ...
  "read")
    ...
    spiON
    echo "Reading ..."
    flashrom -p "$FLASHROM_PROGRAMMER" -r "$FILE" $FLASHROM_CHIP
    sleep 1
    spiOFF
  ;;
  "write")
